...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "block_hammer_beat": [
        ("block_hammer_beat", 1.0),
    ],
    "robotwin_17_tasks": [
        ("robotwin_17_tasks", 1.0),
    ],
    "place_phone_stand": [
        ("place_phone_stand", 1.0),
    ],
    "robotwin2_7tasks": [
        ("robotwin2_7tasks", 1.0),
    ],
    "move_can_pot_1k": [
        ("move_can_pot_1k", 1.0),
    ],
    ...
    "place_phone_stand_1k": [
        ("place_phone_stand_1k", 1.0),
    ],
    "place_a2b_left_1k": [
        ("place_a2b_left_1k", 1.0),
    ],
    "place_a2b_right_1k": [
        ("place_a2b_right_1k", 1.0),
    ],
    "pick_dual_bottles_1k": [
        ("pick_dual_bottles_1k", 1.0),
    ],
     "lift_pot_1k": [
        ("lift_pot_1k", 1.0),
    ],
      "put_bottles_dustbin_1k": [
        ("put_bottles_dustbin_1k", 1.0),
    ],
       "stack_blocks_two_1k": [
        ("stack_blocks_two_1k", 1.0),
    ],
        "stack_bowls_two_1k": [
        ("stack_bowls_two_1k", 1.0),
    ],
       "handover_block_1k": [
        ("handover_block_1k", 1.0),
    ],
       "place_empty_cup_1k": [
        ("place_empty_cup_1k", 1.0),
    ],
       "shake_bottle_1k": [
        ("shake_bottle_1k", 1.0),
    ],
       "move_stapler_pad_1k": [
        ("move_stapler_pad_1k", 1.0),
    ],
       "place_container_plate_1k": [
        ("place_container_plate_1k", 1.0),
    ],   
       "blocks_ranking_rgb_1k": [
        ("blocks_ranking_rgb_1k", 1.0),
    ],   
       "beat_block_hammer_1k": [
        ("beat_block_hammer_1k", 1.0),
    ],   
       "place_mouse_pad_1k": [
        ("place_mouse_pad_1k", 1.0),
    ],   
       "place_shoe_1k": [
        ("place_shoe_1k", 1.0),
    ],   
       "move_pillbottle_pad_1k": [
        ("move_pillbottle_pad_1k", 1.0),
    ],   
       "click_bell_real_20": [
        ("click_bell_real_20", 1.0),
    ],  
       "place_emtpy_cup_real_20": [
        ("place_emtpy_cup_real_20", 1.0),
    ],  
